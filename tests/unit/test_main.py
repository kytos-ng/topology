...
class TestMain:
    ...
    def test_load_link(self):
        ...
        self.napp.controller.get_link_or_create.return_value = (mock_link, True)
        # enable link
    ...
    def test_interface_link_up(self, mock_notify_topology_update):
        ...
        mock_link.is_active.side_effect = False
    ...
    def test_handle_link_down(self, *args):
        ...
        mock_link = create_autospec(Link)
        mock_link.is_active.return_value = True
        mock_interface.link = mock_interface
    ...
    @patch('napps.kytos.topology.main.Main.notify_topology_update')
    def test_handle_link_down_not_active(self, mock_topology_update):
    ...
    def test_notify_interface_link_status(self, args):
        ...
        buffers_app_mock = MagicMock()
        self.napp.controller.buffers.app = buffers_app_mock
        mock_interface = MagicMock(link=Mock())
        mock_link = MagicMock()
